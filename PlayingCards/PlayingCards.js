...
function dealCard(deckOfCards) {
    ...
    deck = deckOfCards;
    console.log(`${topObj.Value} of ${topObj.Suit}`);
    console.log(top)
    console.log(deck);
}
...
function dealFive(deckOfCards) {
    ...
    if (suitObj.size === 1 && !straight(orderObj).includes(false) && orderObj.size === 5) {
    ...
    else if (!straight(orderObj).includes(false) && orderObj.size === 5) {
        pokerHand = "Straight"
    }
